...
- **Invitation Management**: List received invitations as structured connection, page, or newsletter requests; list sent connection requests with recipient details; accept or reject received invitations; and withdraw sent invitations
